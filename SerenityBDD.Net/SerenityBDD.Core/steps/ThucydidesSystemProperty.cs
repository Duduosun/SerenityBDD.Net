...
namespace SerenityBDD.Core.time
{
    public class ThucydidesSystemProperty
    {
        ...
        */
         ...
         */
        public static PropertyBase SERENITY_FLOW_REPORTS_DIR = new PropertyBase("flow");
         ...
         */
        public static PropertyBase SERENITY_BATCH_NUMBER;

        [Obsolete] public static PropertyBase THUCYDIDES_PROXY_HTTP;

        /**
         * HTTP Proxy URL configuration for Firefox and PhantomJS
         */
        public static PropertyBase SERENITY_PROXY_HTTP;
         ...
         */
        public static PropertyBase SERENITY_PROXY_TYPE;

        [Obsolete] public static PropertyBase THUCYDIDES_PROXY_USER;

        /**
         * HTTP Proxy username configuration for Firefox and PhantomJS
         */
        public static PropertyBase SERENITY_PROXY_USER;

        [Obsolete] public static PropertyBase THUCYDIDES_PROXY_PASSWORD;

        /**
         * HTTP Proxy password configuration for Firefox and PhantomJS
         */
        public static PropertyBase SERENITY_PROXY_PASSWORD;

        /**
         * How long webdriver waits for elements to appear by default, in milliseconds.
         */
        public static PropertyBase WEBDRIVER_TIMEOUTS_IMPLICITLYWAIT;

        /**
         * How long webdriver waits by default when you use a fluent waiting method, in milliseconds.
         */
        public static PropertyBase WEBDRIVER_WAIT_FOR_TIMEOUT;

        [Obsolete] public static PropertyBase THUCYDIDES_EXT_PACKAGES;
         ...
         */
        public static PropertyBase CHROME_SWITCHES;

        /**
         * Path to a Chrome-driver specific extensions file
         */
        public static PropertyBase CHROME_EXTENSION;
         ...
         */
        public static PropertyBase SAUCELABS_USER_ID;

        /**
         * Override the default implicit timeout value for the Saucelabs driver.
         */
        public static PropertyBase SAUCELABS_IMPLICIT_TIMEOUT;
         ...
         */
        public static PropertyBase BROWSERSTACK_URL;

        public static PropertyBase BROWSERSTACK_OS;


        [Description("browserstack.os_version")]
        public static PropertyBase BROWSERSTACK_OS_VERSION;

        /**
         * Browserstack uses this property for desktop browsers, like firefox, chrome and IE.
         */
        public static PropertyBase BROWSERSTACK_BROWSER;

        /**
         * Browserstack uses this one for android and iphone.
         */
        [Description("browserstack.browserName")] public static PropertyBase BROWSERSTACK_BROWSERNAME;

        public static PropertyBase BROWSERSTACK_BROWSER_VERSION;

        /**
         * BrowserStack mobile device name on which tests should be run
         */
        public static PropertyBase BROWSERSTACK_DEVICE;

        /**
         * Set the screen orientation of BrowserStack mobile device
         */
        public static PropertyBase BROWSERSTACK_DEVICE_ORIENTATION;

        /**
         * Specify a name for a logical group of builds on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_PROJECT;

        /**
         * Specify a name for a logical group of tests on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_BUILD;

        /**
         * Specify an identifier for the test run on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_SESSION_NAME;

        /**
         * For Testing against internal/local servers on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_LOCAL;

        /**
         * Generates screenshots at various steps in tests on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_DEBUG;

        /**
         * Sets resolution of VM on BrowserStack
         */
        public static PropertyBase BROWSERSTACK_RESOLUTION;

        public static PropertyBase BROWSERSTACK_SELENIUM_VERSION;
         ...
         */
        public static PropertyBase BROWSERSTACK_IE_DRIVER;
         ...
         */
        public static PropertyBase SERENITY_TEST_ROOT;

        [Obsolete] public static PropertyBase THUCYDIDES_REQUIREMENTS_DIR;
         ...
         */
        public static PropertyBase SERENITY_ANNOTATED_REQUIREMENTS_DIR;

        [Obsolete] public static PropertyBase THUCYDIDES_LOWEST_REQUIREMENT_TYPE;
        ...
        [Obsolete] public static PropertyBase THUCYDIDES_REQUIREMENT_TYPES;
        ...
        [Obsolete] public static PropertyBase THUCYDIDES_DATA_DIR;

        /**
         * Where Serenity stores local data.
         */
        public static PropertyBase SERENITY_DATA_DIR;

        /**
         * Allows you to override the default serenity.properties location for properties file.
         */
        public static PropertyBase PROPERTIES;

        [Obsolete] public static PropertyBase THUCYDIDES_TEST_REQUIREMENTS_BASEDIR;
         ...
         */
        public static PropertyBase SERENITY_TEST_REQUIREMENTS_BASEDIR;
        ...
        [Obsolete] public static PropertyBase THUCYDIDES_KEEP_UNSCALED_SCREENSHOTS;
         ...
         */
        public static PropertyBase TAGS;

        /**
         * If provided, each test in a test run will have these tags added.
         */
        public static PropertyBase INJECTED_TAGS;

        [Obsolete] public static PropertyBase THUCYDIDES_CSV_EXTRA_COLUMNS;
        ...
        public static PropertyBase SERENITY_HISTORY_DIRECTORY;

        /**
         * Delete the history directory before a new set of results is recorded
         */
        public static PropertyBase DELETE_HISTORY_DIRECTORY;

        /**
         * Add extra columns to the CSV output, obtained from tag values.
         */
        public static PropertyBase SERENITY_CSV_EXTRA_COLUMNS;

        [Obsolete] public static PropertyBase THUCYDIDES_CONSOLE_HEADINGS;
        ...
        [Obsolete] public static PropertyBase THUCYDIDES_CONSOLE_COLORS;
        public static PropertyBase SERENITY_CONSOLE_COLORS;

        /**
         * If set to true, Asciidoc formatting will be supported in the narrative texts.
         */
        public static PropertyBase NARRATIVE_FORMAT;
         ...
         */
        public static PropertyBase PHANTOMJS_BINARY_PATH;

        /**
         * Path to the Gecko driver binary
         */
        public static PropertyBase WEBDRIVER_GECKO_DRIVER;
         ...
         */
        public static PropertyBase DASHBOARD_TAG_LIST;
         ...
         */
        public static PropertyBase DASHBOARD_EXCLUDED_TAG_LIST;
         ...
         */
        public static PropertyBase FEATURE_FILE_ENCODING;

        /**
         * Fine-tune the number of threads Serenity uses for report generation.
         */
        public static PropertyBase REPORT_THREADS;
        public static PropertyBase REPORT_MAX_THREADS;
        public static PropertyBase REPORT_KEEP_ALIVE_TIME;
         ...
         */
        public static PropertyBase SERENITY_LINKED_TAGS;
        ...
        public static PropertyBase SERENITY_WEBDRIVER_COLLECTION_LOADING_STRATEGY;
         ...
         */
        public static PropertyBase RERUN_FAILURES_DIRECTORY;
         ...
         */
        public static PropertyBase CONTEXT;
